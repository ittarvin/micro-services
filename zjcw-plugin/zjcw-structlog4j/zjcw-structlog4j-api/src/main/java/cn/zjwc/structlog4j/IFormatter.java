package cn.zjwc.structlog4j;

import org.slf4j.Logger;

/**
 * Standard format/encoder interface.
 * The SLF4J logger is passed into every method for any internal error reporting within the formatter itself
 *
 * BLD = builder object specific to a formatter passed around from start() till end()
 *
